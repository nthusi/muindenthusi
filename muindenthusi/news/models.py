...
from muindenthusi.utils.models import BasePage, ArticleTopic
from muindenthusi.utils.blocks import CaptionedImageBlock, StoryBlock, FeaturedArticleBlock


class ArticlePage(NewsletterPageMixin,BasePage):
    template = "pages/article_page.html"
    parent_page_types = ["news.NewsListingPage"]
    newsletter_template = "pages/article_page_newsletter.html"
